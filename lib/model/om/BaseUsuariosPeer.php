...
abstract class BaseUsuariosPeer {
    ...
    const CONTRASENIA = 'Usuarios.CONTRASENIA';

    /** the column name for the CARGO field */
    const CARGO = 'Usuarios.CARGO';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Nombre', 'Contrasenia', 'Cargo', 'Id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Nombre' => 0, 'Contrasenia' => 1, 'Cargo' => 2, 'Id' => 3, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuariosPeer::CONTRASENIA);
            $criteria->addSelectColumn(UsuariosPeer::CARGO);
