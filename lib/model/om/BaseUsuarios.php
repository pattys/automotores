 ...
 */
abstract class BaseUsuarios extends BaseObject 
{
    ...
    public function setContrasenia($v)
    {
        ...
        if ($this->contrasenia !== $v) {
            $this->contrasenia = $v;
            $this->modifiedColumns[] = UsuariosPeer::CONTRASENIA;
        }
    ...
    public function setCargo($v)
    {
        ...
        if ($this->cargo !== $v) {
            $this->cargo = $v;
            $this->modifiedColumns[] = UsuariosPeer::CARGO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->contrasenia = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->cargo = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 4; // 4 = UsuariosPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsuariosPeer::NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`NOMBRE`';
        }
        if ($this->isColumnModified(UsuariosPeer::CONTRASENIA)) {
            $modifiedColumns[':p' . $index++]  = '`CONTRASENIA`';
        }
        if ($this->isColumnModified(UsuariosPeer::CARGO)) {
            $modifiedColumns[':p' . $index++]  = '`CARGO`';
        }
        if ($this->isColumnModified(UsuariosPeer::ID)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[1] => $this->getContrasenia(),
            $keys[2] => $this->getCargo(),
            $keys[3] => $this->getId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setContrasenia($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setCargo($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuariosPeer::CONTRASENIA)) $criteria->add(UsuariosPeer::CONTRASENIA, $this->contrasenia);
        if ($this->isColumnModified(UsuariosPeer::CARGO)) $criteria->add(UsuariosPeer::CARGO, $this->cargo);
    ...
    public function __call($name, $params)
    {
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseUsuarios:' . $name))
		{
